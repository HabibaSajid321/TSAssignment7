...
function strToLowerCase(str:string):string{
   return str.toLowerCase();
}

function strToUperCase(str:string):string{
...
function anyCasefunc(str:string, anyFunc:(s:string)=>string):string{
    return anyFunc(str);
}

let name1:string = "habiba sajid";
let tolowecase1 = anyCasefunc(name1, strToLowerCase);
console.log(tolowecase1);

let toupcase:string = anyCasefunc(name1, strToUperCase);
console.log(toupcase);

let title:string = anyCasefunc(name1, toTitleCase);
console.log(title);
...
let famousPerson2:string = "Albert Einstein";
let famousQuote2:string = `“A person who never made a mistake never tried anything new.”`
...
let name4:string = "\tSajid \nAli"
console.log(name4);

let newName:string = name4.trim() 
console.log(newName);
...
let friends:string[] = ["Raima","Alina","Iqra"];
...
function greet(friendsname:string[]){
...
let list :string[] = ["Bmw", "bike","cycle"];
...
let dinnerList:string[] = ["Raima","Alina","Iqra"];
...
function alcolor(color:string):string{
    let alien_color ="";
    if (alien_color === 'green') {
      console.log("Congratulations! You just earned 5 points.");
    }
...
const age :number= 30; // Change the age to test different scenarios
...
const users: string[] = ['admin', 'Eric', 'Alice', 'Bob', 'John'];
